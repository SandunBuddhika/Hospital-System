 ...
 */
public class Appointment_Process extends javax.swing.JPanel {
    ...
    public Appointment_Process(Dashboard d) {
        initComponents();
    ...
    public Appointment_Process(Item_Invoice iv) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Appoiment Process");
        ...
        jLabel5.setText("Appointment Info");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setText("Process Info");
        ...
        jButton12.setText("Make a Invoice");
...
//            search();
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        int s_row = jTable1.getSelectedRow();
        if (s_row != -1) {
            Item_Invoice it = new Item_Invoice(this, jTable1.getValueAt(s_row, 0).toString());
            Home.jPanel3.removeAll();
            Home.jPanel3.setLayout(new CardLayout());
            Home.jPanel3.revalidate();
            Home.jPanel3.repaint();
            ...
            JOptionPane.showMessageDialog(this, "Please enter a process", "WARNING", JOptionPane.WARNING_MESSAGE);
        }
